""" Akshay Lavhagale
    Homework 11
    Moving our solution from HW10 to a relational database """
...
class Repository:
    def __init__(self, wdir, pt_tables=True):
        ...
        if pt_tables:
            ...
            print("\nInstructor Summary Db")
            self.instructor_table_db("DatabaseName.db")
    ...
    def instructor_table_db(self, dbpath):
